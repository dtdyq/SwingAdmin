	...
	extends JPanel
{
	BasicComponentsPanel() {
		...
		// whole words button
		JToggleButton wordsButton = new JToggleButton( new FlatSVGIcon( "icons/words.svg" ) );
