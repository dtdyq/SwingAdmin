	...
	extends JPanel
{
	...
	private void customComponentsChanged() {
		...
		if( trailingComponentButton.isSelected() ) {
			...
			trailing.add( new JButton( new FlatSVGIcon( "icons/buildLoadChanges.svg" ) ) );
			trailing.add( Box.createHorizontalGlue() );
			trailing.add( new JButton( new FlatSVGIcon( "icons/commit.svg" ) ) );
			trailing.add( new JButton( new FlatSVGIcon( "icons/diff.svg" ) ) );
			trailing.add( new JButton( new FlatSVGIcon( "icons/listFiles.svg" ) ) );
		}
	...
	private void initTabIconPlacement( JTabbedPane tabbedPane, int iconPlacement ) {
		...
		tabbedPane.addTab( "Search", new FlatSVGIcon( "icons/search.svg", iconSize, iconSize ), null );
		tabbedPane.addTab( "Recents", new FlatSVGIcon( "icons/RecentlyUsed.svg", iconSize, iconSize ), null );
		if( topOrBottom )
			tabbedPane.addTab( "Favorites", new FlatSVGIcon( "icons/favorite.svg", iconSize, iconSize ), null );
	}
	...
	private void initTabWidthMode( JTabbedPane tabbedPane, String tabWidthMode ) {
		...
		if( tabWidthMode.equals( TABBED_PANE_TAB_WIDTH_MODE_COMPACT ) ) {
			tabbedPane.addTab( "Search", new FlatSVGIcon( "icons/search.svg", 16, 16 ), null );
			tabbedPane.addTab( "Recents", new FlatSVGIcon( "icons/RecentlyUsed.svg", 16, 16 ), null );
			tabbedPane.addTab( "Favorites", new FlatSVGIcon( "icons/favorite.svg", 16, 16 ), null );
		} else {
